            ...
            {user && (
                <div className="flex relative">
                    ...
                    <div className="relative">
                        <img
                            className="hidden md:block h-10 w-10 rounded-2xl mt-4 cursor-pointer"
                            src={user?.photoURL}
                            alt="user-logo"
                            onClick={() => setShowDropdown(!showDropdown)}
                        />
                        {showDropdown && (
                            <div className=" w-28 h-8 absolute top-[13] right-0 bg-white  rounded-lg text-white">
                                <button
                                    onClick={handleSignOut}
                                    className="w-full text-center text-semibold pt-1 p-2 text-black"
                                >
                                    Sign Out
                                </button>
                            </div>
