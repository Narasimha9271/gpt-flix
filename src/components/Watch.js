...
import { addCast, addMovieDetail, addTrailer } from "../utils/movieSlice";
        ...
        <>
            {trailerData?.key ? (
                <div className=" bg-black text-white">
                    ...
                    <div className="md:flex p-[30px]">
                        <div className="md:pl-[80px] md:pr-[80px] mr-[15px]  ">
                            <img
                                className=" w-56 mb-5 md:mb-0 rounded-lg  md:w-[550px] md:h-[500px] justify-center align-middle m-auto"
                                alt="backgroundimage"
                        ...
                        <div className="md:w-[780px]  md:mr-[95px]">
                            ...
                            <div className="text-yellow-400 text-sm md:text-none mt-3 mb-3">
                                {MovieDetail?.tagline}
                            </div>
                            ...
                            <div className="flex">
                                ...
                                <div className="mt-2 ml-2">
                                    <p className=" bg-yellow-400 text-black font-bold w-12 h-12 text-center pt-2 border border-yellow-400  rounded-[100%]">
                                        {MovieDetail?.vote_average.toFixed(1)}
                                    </p>
                                </div>
                            </div>
                            <div>
                                <h1 className="text-xl  text-white mt-3 mb-3">
                                    Overview :
                                </h1>
                                <div className="text-sm md:w-[65%]">
                            ...
                            <div className="md:flex mt-7 mb-3">
                                <div className="flex md:flex-none">
                                    ...
                                    <div className="md:text-l w-56  ml-2 md:ml-0 text-gray-400 brightness-105 ">
                                        {" "}
                                        {MovieDetail?.status}
                                    </div>
                                </div>
                                ...
                                <div className="flex md:flex-none">
                                    ...
                                    <div className="md:text-l md:w-56 ml-2 md:ml-0 text-gray-400 brightness-105 ">
                                        {" "}
                                        {MovieDetail?.release_date}
                                    </div>
                                </div>
                            ...
                            <h1 className="text-semibold text-xl mt-3">
                                Top Cast
                            </h1>
                                        ...
                                        return (
                                            <div className="" key={item.id}>
                                                <div>
                                                    ...
                                                    <div className="w-[90px] text-[10px] m-auto">
                                                        {item.name}
                                                    </div>
                                                    <div className="text-[12px] w-[50px] h-[20px] overflow-clip text-gray-400 m-auto">
                                                        {item.character}
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div className="md:flex p-[30px]">
                    <div className="md:pl-[80px] md:pr-[80px] mr-[15px]  ">
                        <img
                            className="rounded-lg  md:w-[550px] md:h-[700px] justify-center align-middle m-auto"
                            alt="backgroundimage"
                            src={IMG_CDN_URL + MovieDetail?.poster_path}
                        />
                    </div>
                    <div className="md:w-[780px]  md:mr-[95px]">
                        ...
                        <div className="text-yellow-400 text-sm md:text-none mb-3">
                            {MovieDetail?.tagline}
                        </div>
                        ...
                        <div className="md:flex mt-7 mb-3">
                            <div className="flex md:flex-none">
                                ...
                                <div className="md:text-xl w-56  ml-2 md:ml-0 text-gray-400 brightness-105 ">
                                    {" "}
                                    {MovieDetail?.status}
                                </div>
                            </div>
                            ...
                            <div className="flex md:flex-none">
                                ...
                                <div className="md:text-xl md:w-56 ml-2 md:ml-0 text-gray-400 brightness-105 ">
                                    {" "}
                                    {MovieDetail?.release_date}
                                </div>
                            </div>
